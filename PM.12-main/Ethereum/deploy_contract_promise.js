// node deploy_contract_promise.js HelloSol password ipc

var username = process.argv[2];
var contract_to_deploy = process.argv[3];
var unlock_password = process.argv[4];
var provider = process.argv[5];
...
if(provider == 'ipc')
{
  ...
  web3 = new Web3(new Web3.providers.IpcProvider(`/home/${username}/node1/geth.ipc`, net));
}
